import {
    ...
    CLS,
    DRW,
    JP, JP0, LD, LDXDT, LDI, LDK, LDR,
    Opcode, OR,
    parse,
    RET, RND,
    SE,
    SER, SHL, SHR, SKNP, SKP,
    SNE,
    SNER,
    split4Bit4,
    findValue,
...
describe("parse()", () => {
    ...
    test.each([
        ...
        [0x3000, new SE(0x0, 0x00)],
        [0x312f, new SE(0x1 , 0x2f)],
        [0x4000, new SNE(0x0, 0x00)],
        [0x412f, new SNE(0x1 , 0x2f)],
        [0x5000, new SER(0x0, 0x0)],
        [0x5120, new SER(0x1 , 0x2)],
        [0x6ecf, new LD(0xe, 0xcf)],
        [0x612f, new LD(0x1 , 0x2f)],
        [0x7ecf, new ADD(0xe, 0xcf)],
        [0x712f, new ADD(0x1 , 0x2f)],
        [0x8ec0, new LDR(0xe, 0xc)],
        [0x8120, new LDR(0x1 , 0x2)],
        ...
        [0x8ec4, new ADDR(0xe, 0xc)],
        [0x8124, new ADDR(0x1 , 0x2)],
        [0x8ec5, new SUB(0xe, 0xc)],
        [0x8125, new SUB(0x1 , 0x2)],
        [0x8ec6, new SHR(0xe, 0xc)],
        [0x8126, new SHR(0x1 , 0x2)],
